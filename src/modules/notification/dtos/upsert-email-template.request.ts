...
export class UpsertEmailTemplateDto {
  ...
  constructor(input: Record<string, any>) {
    ...
    this.label = input.label?.toString().trim();
    this.description = input.description?.toString().trim();
    this.subject = input.subject?.toString().trim();
    this.message = input.message?.toString().trim();
    this.template = input.template?.toString().trim();
  }
