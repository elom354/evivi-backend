...
export class AdminAccountController {
  ...
  @ApiOperation({
    summary:
      "Récupérer les informations du profil de l'administrateur connecté",
  })
  ...
  @ApiOperation({
    summary:
      "Mettre à jour les informations du profil de l'administrateur connecté",
  })
  ...
  @ApiOperation({
    summary: "Mettre à jour l'adresse e-mail de l'administrateur connecté",
  })
  ...
  @ApiOperation({
    summary:
      "Mettre à jour le numéro de téléphone de l'administrateur connecté",
  })
  ...
  @ApiOperation({
    summary: "Mettre à jour le mot de passe de l'administrateur connecté",
  })
